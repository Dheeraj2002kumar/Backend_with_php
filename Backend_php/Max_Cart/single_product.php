        ...
        <?php foreach($single_product as $row){ ?>
                ...
                <div class="col-md-5">
                    <div class="product-content">
                        ...
                        <span class="price"><?php echo $cur_format; ?>  <?php echo $row['product_price']; ?></span><br><br>
                        <a class="add-to-cart" data-id="<?php echo $row['product_id']; ?>" href="">Add to cart</a> 
                        <a class="add-to-wishlist" data-id="<?php echo $row['product_id']; ?>" href="">Add to Wislist</a><br> <br>
